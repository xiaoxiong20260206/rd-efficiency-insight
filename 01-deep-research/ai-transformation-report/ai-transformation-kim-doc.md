...
![全文概览：四阶段演进模型](./images/ch00-overview.png)
...
![问题根源：四个不等于 + BCG 10-20-70法则](./images/ch01-problem.png)
...
![阶段一：让AI变成肌肉记忆](./images/ch02-stage1.png)
...
![阶段二：让每个工种找到AI原生工作方式](./images/ch03-stage2.png)
...
![阶段三：让人+AI混编成为新常态](./images/ch04-stage3.png)
...
![阶段四：因AI做全新的事](./images/ch05-stage4.png)
...
![行动指南：诊断阶段 → 匹配行动 → 规避陷阱](./images/ch06-summary.png)
...
![彩蛋：1人+AI×2天 = 传统模式的5倍产出](./images/ch07-epilogue-ai.jpg)

![彩蛋图解：AI协作生产流程](./images/ch07-epilogue.png)
